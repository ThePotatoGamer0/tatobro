...
/** @type {string} */
const CACHE_VERSION = '1752396379|13462557083';
/** @type {string} */
const CACHE_PREFIX = 'Tatobro-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Tatobro.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Tatobro.html","Tatobro.js","Tatobro.offline.html","Tatobro.icon.png","Tatobro.apple-touch-icon.png","Tatobro.audio.worklet.js","Tatobro.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Tatobro.wasm","Tatobro.pck"];
